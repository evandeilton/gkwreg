...
$$f(y; \alpha, \beta, \gamma, \delta, \lambda) = \frac{\lambda \alpha \beta y^{\alpha-1} (1-y^\alpha)^{\beta-1}}{B(\gamma, \delta)} \left[1-(1-y^\alpha)^\beta\right]^{\gamma\lambda-1} \left\{1-\left[1-(1-y^\alpha)^\beta\right]^\lambda\right\}^{\delta-1}$$
