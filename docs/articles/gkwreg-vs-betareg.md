...
|:---|:---|---:|---:|---:|---:|---:|
| S1: Well-Specified Beta | Beta (betareg) | 200 | 100.0 | -224.74 | 0.192 | 0.012 |
| S1: Well-Specified Beta | Beta (gkwreg) | 200 | 100.0 | -181.12 | 0.228 | 0.190 |
| S1: Well-Specified Beta | Kumaraswamy | 200 | 100.0 | -219.76 | 0.199 | 0.181 |
| S1: Well-Specified Beta | Exp. Kumaraswamy | 200 | 100.0 | -219.24 | 0.662 | 0.198 |
| S2: Heavy Tails | Beta (betareg) | 200 | 100.0 | -139.28 | 0.191 | 0.012 |
| S2: Heavy Tails | Beta (gkwreg) | 200 | 100.0 | -116.79 | 0.210 | 0.016 |
| S2: Heavy Tails | Kumaraswamy | 200 | 100.0 | -115.77 | 0.194 | 0.009 |
| S2: Heavy Tails | Exp. Kumaraswamy | 200 | 58.0 | -213.45 | 0.618 | 0.027 |
| S3: Extreme Shapes | Beta (betareg) | 200 | 4.5 | 16677.68 | 0.405 | 0.286 |
| S3: Extreme Shapes | Beta (gkwreg) | 200 | 100.0 | -2007.68 | 0.292 | 0.027 |
| S3: Extreme Shapes | Kumaraswamy | 200 | 100.0 | -2257.56 | 0.266 | 0.012 |
| S3: Extreme Shapes | Exp. Kumaraswamy | 105 | 80.0 | -2331.45 | 0.365 | 0.040 |
...
|:-----------------|----------------:|---------------:|
| Kumaraswamy      |           0.067 |          1.540 |
| Beta (gkwreg)    |           0.078 |          1.333 |
| Exp. Kumaraswamy |           0.088 |          1.174 |
| Beta (betareg)   |           0.104 |          1.000 |
...
## Session Information
    ...
    [28] tools_4.5.2            flexmix_2.3-20         dplyr_1.2.0           
    [31] vctrs_0.7.1            R6_2.6.1               stats4_4.5.2          
    [34] zoo_1.8-15             lifecycle_1.0.5        fs_1.6.6              
    ...
    [46] Rcpp_1.1.1             systemfonts_1.3.1      tidyselect_1.2.1      
    [49] tibble_3.3.1           xfun_0.56              lmtest_0.9-40         
    [52] rstudioapi_0.18.0      knitr_1.51             farver_2.1.2          
    [55] htmltools_0.5.9        rmarkdown_2.30         gkwdist_1.1.2         
    [58] TMB_1.9.19             compiler_4.5.2         S7_0.2.1              
