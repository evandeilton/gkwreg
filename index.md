# gkwreg: Generalized Kumaraswamy Regression Models for Bounded Data ![](reference/figures/gkwreg.png)
...
Information criteria: [`AIC()`](https://rdrr.io/r/stats/AIC.html),
[`BIC()`](https://rdrr.io/r/stats/AIC.html) with multi-model
comparison - Automated nesting detection and proper test statistics
...
| **Optimization Control**   | [`gkw_control()`](https://evandeilton.github.io/gkwreg/reference/gkw_control.md) (detailed) | Basic           | Moderate       | Extensive      |
...
- **Reference Manual**:
  [`help(package = "gkwreg")`](https://evandeilton.github.io/gkwreg/reference)
...
[LICENSE](https://evandeilton.github.io/gkwreg/LICENSE) file for
details.
