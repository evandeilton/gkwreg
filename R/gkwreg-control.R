...
#'   tighter convergence but may increase computation time.
#'
...
#'     \item 2+: Print detailed diagnostic information
#'   }
...
print.gkw_control <- function(x, ...) {
  ...
  cat("  Absolute tolerance:", format(x$abstol, scientific = TRUE), "\n")
