...
// 
// // ========================
// // KKw log-PDF - Specialized for Kumaraswamy-Kumaraswamy with γ=1 fixed
// // ========================
// template <class Type>
// Type log_pdf_kkw(const Type &y,
//                  const Type &alpha,
//                  const Type &beta,
//                  const Type &delta,
//                  const Type &lambda) {
...
//   Type log_delta_plus_1 = safeLog(delta + Type(1.0));
// 
//   // Term 1: log(λαβ(δ+1))
//   Type term1 = log_lambda + log_alpha + log_beta + log_delta_plus_1;
// 
...
// 
//   // Transform: w = 1-v^λ
//   Type v_lambda = safePow(v, lambda);
//   Type w = enforceProbability(Type(1.0) - v_lambda);
// 
//   // Term 5: δlog(w)
//   Type term5 = delta * safeLog(w);
// 
...
// // ========================
// template <class Type>
// Type calc_mean_kkw(const Type &alpha,
//                    const Type &beta,
//                    const Type &delta,
//                    const Type &lambda) {
//   const int n_points = 30;
...
// 
// // ========================
// // Calculate CDF of KKw distribution
// // ========================
// template <class Type>
// Type cdf_kkw(const Type &y,
//              const Type &alpha,
//              const Type &beta,
//              const Type &delta,
//              const Type &lambda) {
...
//   Type v_lambda = safePow(v, lambda);
// 
//   // Step 6: 1-[1-(1-y^α)^β]^λ
//   Type w = Type(1.0) - v_lambda;
// 
//   // Step 7: {1-[1-(1-y^α)^β]^λ}^(δ+1)
//   Type w_delta_plus_1 = safePow(w, delta + Type(1.0));
// 
//   // Final CDF: 1-{1-[1-(1-y^α)^β]^λ}^(δ+1)
//   return Type(1.0) - w_delta_plus_1;
// }
// 
// // ========================
...
//       alphaVec, betaVec, deltaVec, lambdaVec,
...
//   vector<Type> alphaVec(n), betaVec(n), deltaVec(n), lambdaVec(n);
// 
