...
Type objective_function<Type>::operator() () {
  ...
  DATA_INTEGER(useMeanCache);  // Restored
  DATA_INTEGER(userChunkSize);  // Restored (but not used in simple loop)
...
// 
// // ========================
// // Mc log-PDF - Specialized for McDonald with α=1 and β=1 fixed
// // ========================
// template <class Type>
// Type log_pdf_mc(const Type &y,
//                 const Type &gamma,
//                 const Type &delta,
//                 const Type &lambda) {
...
// 
//   // Compute log-beta function B(γ, δ+1)
//   Type logB_val = logBeta(gamma, delta + Type(1.0));
// 
//   // Term 1: log(λ) - log(B(γ, δ+1))
//   Type term1 = log_lambda - logB_val;
// 
//   // Term 2: (γλ-1)log(y)
//   Type term2 = (gamma * lambda - Type(1.0)) * safeLog(y);
// 
//   // Transform: y^λ
//   Type y_lambda = safePow(y, lambda);
// 
//   // Term 3: δlog(1-y^λ)
//   Type term3 = delta * safeLog(Type(1.0) - y_lambda);
// 
...
// // ========================
// template <class Type>
// Type calc_mean_mc(const Type &gamma,
//                   const Type &delta,
//                   const Type &lambda) {
//   const int n_points = 30;
// 
...
//   vector<Type> gammaVec(n), deltaVec(n), lambdaVec(n);
// 
...
//   Type delta_mean  = deltaVec.sum()/Type(n);
//   Type lambda_mean = lambdaVec.sum()/Type(n);
//   // For Mc, α and β are fixed at 1.0
//   Type alpha_mean  = Type(1.0);
//   Type beta_mean   = Type(1.0);
// 
