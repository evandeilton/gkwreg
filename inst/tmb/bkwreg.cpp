...
// 
// // ========================
// // BKw log-PDF - Specialized for Beta-Kumaraswamy with λ=1 fixed
// // ========================
// template <class Type>
// Type log_pdf_bkw(const Type &y,
//                  const Type &alpha,
//                  const Type &beta,
//                  const Type &gamma,
//                  const Type &delta) {
...
//       gamma <= Constants<Type>::eps_pos ||
//       delta <= Constants<Type>::eps_pos) {
//     return -Constants<Type>::inf_repl;
//   }
// 
//   // Compute the log-beta function value B(γ, δ+1)
//   Type logB_val = logBeta(gamma, delta + Type(1.0));
// 
...
// 
//   // Term 4: (γ-1)log(v)
//   Type term4 = (gamma - Type(1.0)) * safeLog(v);
// 
...
// // ========================
// template <class Type>
// Type calc_mean_bkw(const Type &alpha,
//                    const Type &beta,
//                    const Type &gamma,
//                    const Type &delta) {
//   const int n_points = 30;
...
//       alphaVec, betaVec, gammaVec, deltaVec,
...
//   vector<Type> alphaVec(n), betaVec(n), gammaVec(n), deltaVec(n);
// 
